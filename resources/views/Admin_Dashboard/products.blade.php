    ...
    <div class="content ">
        <div style="margin: 0% 6% ">
            <div style="width: 100%">
                ...
                <h1 class="mx-auto"> Manage Your Products </h1> <a href="Project_Create"><button class="btn btn-success"
                        type="submit" style="position:absolute ; right :5%"> + Add Product</button>
                </a>
                <br>
                <br>
                    ...
                    <tbody>
                        ...
                        <td>{{ $product['prot'] }}</td> --}}
                                ...
                                <td>
                                    ...
                                    <div>
                                        @if ($product->img)
                                            <img src="{{ asset($product->img) }}" alt="{{ $product->name }}" width="80"
                                                height="80">
                                            <img src="{{ asset($product->img1) }}" alt="{{ $product->name }}" width="80"
                                                height="80">
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <form action="productview/{{ $product['id'] }}" method=""
                                                style="margin-bottom: 2px">
                                                @csrf
                                                <button class="btn  far fa-eye text-primary fa-lg" type="submit"
                                                    value="Update"></button>
                                            </form>
                                        </div>
                                    </div>
